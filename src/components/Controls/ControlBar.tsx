...
export default function ControlBar() {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 bg-bg-secondary/90 backdrop-blur-xl border-t border-white/5 z-50">
      {/* 进度条 */}
      <ProgressBar />
      ...
      <div className="flex items-center justify-between px-4 py-2">
        ...
        <div className="flex items-center gap-2 w-1/4">
          ...
          <button
            ...
            className="flex items-center gap-1 text-text-muted hover:text-text-primary transition-colors text-xs px-2 py-1 rounded-full hover:bg-white/10"
            aria-label="播放列表"
          >
            <ListMusic size={14} />
